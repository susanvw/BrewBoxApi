        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Drinks_AspNetUsers_CreatedById",
                        column: x => x.CreatedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Drinks_AspNetUsers_DeletedById",
                        column: x => x.DeletedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Drinks_AspNetUsers_ModifiedById",
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: false),
                    BaristaId = table.Column<string>(type: "nvarchar(450)", maxLength: 450, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Orders_AspNetUsers_BaristaId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DrinkId = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: false),
                    Price = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_OrderDrinks_AspNetUsers_CreatedById",
                        column: x => x.CreatedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_OrderDrinks_AspNetUsers_DeletedById",
                        column: x => x.DeletedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_OrderDrinks_AspNetUsers_ModifiedById",
                        column: x => x.ModifiedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Drinks_DeletedById",
                table: "Drinks",
                column: "DeletedById");

            migrationBuilder.CreateIndex(
                name: "IX_Drinks_ModifiedById",
                table: "Drinks",
                column: "ModifiedById");

            migrationBuilder.CreateIndex(
                name: "IX_Drinks_Type_Size",
                table: "Drinks",
                columns: new[] { "Type", "Size" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_OrderDrinks_CreatedById",
                table: "OrderDrinks",
                column: "CreatedById");

            migrationBuilder.CreateIndex(
                name: "IX_OrderDrinks_DeletedById",
                table: "OrderDrinks",
                column: "DeletedById");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderDrinks_ModifiedById",
                table: "OrderDrinks",
                column: "ModifiedById");
